...
/// <summary>
/// EN: Handles the Deactivate Listing command.
/// FA: فرمان غیرفعال‌سازی Listing را مدیریت می‌کند.
/// </summary>
public sealed class DeactivateListingHandler
    : IRequestHandler<DeactivateListingCommand, Result<ListingId>>
{
    ...
    /// </summary>
    public DeactivateListingHandler(
    ...
    public async Task<Result<ListingId>> Handle(
        DeactivateListingCommand request,

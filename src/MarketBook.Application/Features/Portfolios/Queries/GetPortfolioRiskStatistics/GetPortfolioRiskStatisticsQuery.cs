...
/// <summary>
/// EN: Requests volatility and downside-deviation statistics for a portfolio.
/// FA: آمار نوسان و انحراف نزولی پرتفوی را درخواست می‌کند.
/// </summary>
...
public sealed record GetPortfolioRiskStatisticsQuery(
    string PortfolioId,
    DateTimeOffset From,
    DateTimeOffset To,
    string Interval)
    : IRequest<Result<GetPortfolioRiskStatisticsResponse>>;

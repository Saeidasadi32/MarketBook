...
/// <summary>
/// EN: Requests rolling historical VaR/CVaR ratios and base-currency amounts.
/// FA: نسبت‌ها و مبالغ VaR/CVaR تاریخی Rolling را در ارز پایه درخواست می‌کند.
/// </summary>
...
/// <param name="WindowPeriods">EN: Periodic-return observations per full rolling window. FA: تعداد بازده‌های دوره‌ای در هر پنجره کامل Rolling.</param>
/// <param name="ConfidenceLevel">EN: Historical confidence level. FA: سطح اطمینان تاریخی.</param>
public sealed record GetPortfolioRollingValueAtRiskAmountQuery(
    string PortfolioId,
    DateTimeOffset From,
    DateTimeOffset To,
    string Interval,
    ...
    : IRequest<Result<GetPortfolioRollingValueAtRiskAmountResponse>>;

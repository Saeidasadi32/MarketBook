...
/// <summary>
/// EN: Handles deactivate trading calendars.
/// FA: غیرفعال‌سازی تقویم معاملاتی را مدیریت می‌کند.
/// </summary>
public sealed class DeactivateTradingCalendarHandler
    : IRequestHandler<DeactivateTradingCalendarCommand, Result<TradingCalendarId>>
{
    ...
    /// </summary>
    public DeactivateTradingCalendarHandler(
    ...
    public async Task<Result<TradingCalendarId>> Handle(
        DeactivateTradingCalendarCommand request,
